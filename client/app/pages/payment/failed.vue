  ...
  <GuestLayout>
    <div class="min-h-screen flex items-center justify-center px-4 py-20">
      <div class="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
        ...
        <p class="text-gray-400 text-sm mb-2">Your GCash payment was not completed.</p>
        <p class="text-gray-400 text-sm mb-8">Order #{{ orderId }} has been saved. You can retry payment from your orders page.</p>
        <NuxtLink
          to="/customer/orders"
