<template>
  <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 group relative overflow-hidden">
    ...
    <div class="p-4 pt-2">
      ...
      <!-- Name -->
      <NuxtLink to="/customer/products/1">
      ...
      <!-- Add to Cart Button -->
      <button class="w-8 h-8 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center ml-auto transition-colors">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// ProductCard.vue
// Reusable product card used in ProductsSection, HotDeals, NewestProducts
