...
<!-- Buy Now -->
        <button
          ...
          class="flex-1 text-xs font-semibold py-2 rounded-xl border border-gray-800 text-gray-800 hover:bg-gray-800 hover:text-white transition-all flex items-center justify-center gap-1"
        >
