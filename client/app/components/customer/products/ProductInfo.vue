<template>
  <div class="flex flex-col gap-4">
    ...
    <div class="flex items-center gap-3 pt-2">
      ...
      <button @click="addToCart" class="flex-1 bg-green-500 hover:bg-green-600 text-white font-semibold py-2.5 px-6 rounded-full flex items-center justify-center gap-2 transition-colors shadow-md">
