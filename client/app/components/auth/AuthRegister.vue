<template>
  <div class="px-6 py-8">
    ...
    <p class="text-gray-400 text-sm mb-6">Join Bagsakan Urdaneta today</p>
    ...
    <form @submit.prevent="handleRegister" class="flex flex-col gap-4">
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1.5">
          Phone Number
          <span class="text-xs text-gray-400 font-normal ml-1">(for SMS verification)</span>
        </label>
    ...
    <p class="text-center text-xs text-gray-400 mt-4">
      ...
      <button @click="$emit('goto', 'login')" class="text-green-500 font-semibold hover:underline">
        Log In
      </button>
    </p>
